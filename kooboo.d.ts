...
declare namespace Kooboo.Sites.Scripting.Global.Mail.Amazonses {
  interface Amazonses {
    /** ```ts
var mail = k.mail.amazonses.createEmail({accessKeyId:'YOUR_AWS_ACCESS_KEY' ,secretAccessKey:'YOUR_AWS_SECRET_KEY',region:'EUCentral1'});
...
declare namespace Kooboo.KContent {
  interface KContentInstance {
    TemplatePage: Kooboo.KContent.Folders.TemplatePage;
    MetaData: Kooboo.KContent.Folders.MetaData;
    PlaceCategory: Kooboo.KContent.Folders.PlaceCategory;
    PageElement_RelatedLocation: Kooboo.KContent.Folders.PageElement_RelatedLocation;
    PageElement_FAQ: Kooboo.KContent.Folders.PageElement_FAQ;
    PlanTip: Kooboo.KContent.Folders.PlanTip;
    GerelateerdeInfo: Kooboo.KContent.Folders.GerelateerdeInfo;
    Client: Kooboo.KContent.Folders.Client;
    LocationRelative: Kooboo.KContent.Folders.LocationRelative;
    FAQ: Kooboo.KContent.Folders.FAQ;
    PageElement_Video: Kooboo.KContent.Folders.PageElement_Video;
    Location: Kooboo.KContent.Folders.Location;
    PageElement_2Cards: Kooboo.KContent.Folders.PageElement_2Cards;
    HomeLandscapeCard: Kooboo.KContent.Folders.HomeLandscapeCard;
    Events: Kooboo.KContent.Folders.Events;
    Region: Kooboo.KContent.Folders.Region;
    PageElement_SubscribeNewsletter: Kooboo.KContent.Folders.PageElement_SubscribeNewsletter;
    CommonBtn: Kooboo.KContent.Folders.CommonBtn;
    PageElement_Carrousel: Kooboo.KContent.Folders.PageElement_Carrousel;
    PageElement_Audio: Kooboo.KContent.Folders.PageElement_Audio;
    WebsiteMeta: Kooboo.KContent.Folders.WebsiteMeta;
    PageElement_FullLengthImage: Kooboo.KContent.Folders.PageElement_FullLengthImage;
    PageElement_TagCardList: Kooboo.KContent.Folders.PageElement_TagCardList;
    CMS_KeyValue: Kooboo.KContent.Folders.CMS_KeyValue;
    Places: Kooboo.KContent.Folders.Places;
    Audio: Kooboo.KContent.Folders.Audio;
    PageElement_SubscribePromo: Kooboo.KContent.Folders.PageElement_SubscribePromo;
    Steps: Kooboo.KContent.Folders.Steps;
    HomeHero: Kooboo.KContent.Folders.HomeHero;
    Hotels: Kooboo.KContent.Folders.Hotels;
    PageElement_SearchBar: Kooboo.KContent.Folders.PageElement_SearchBar;
    Category: Kooboo.KContent.Folders.Category;
    CommonButton: Kooboo.KContent.Folders.CommonButton;
    Blog: Kooboo.KContent.Folders.Blog;
    PageElement_MapCards: Kooboo.KContent.Folders.PageElement_MapCards;
    SubscriptionPlanPrice: Kooboo.KContent.Folders.SubscriptionPlanPrice;
    FAQItem: Kooboo.KContent.Folders.FAQItem;
    EmailConfig: Kooboo.KContent.Folders.EmailConfig;
    PageElement_ContentCard: Kooboo.KContent.Folders.PageElement_ContentCard;
    EmbeddedTemplatePages: Kooboo.KContent.Folders.EmbeddedTemplatePages;
    LableFolder: Kooboo.KContent.Folders.LableFolder;
    PageElement_ImageAndText: Kooboo.KContent.Folders.PageElement_ImageAndText;
    FooterItem: Kooboo.KContent.Folders.FooterItem;
    PageElement_3Cards: Kooboo.KContent.Folders.PageElement_3Cards;
    LocationHighlights: Kooboo.KContent.Folders.LocationHighlights;
    modules_GoogleCode: Kooboo.KContent.Folders.modules_GoogleCode;
    Clients: Kooboo.KContent.Folders.Clients;
    EventsTable: Kooboo.KContent.Folders.EventsTable;
    LocationTips: Kooboo.KContent.Folders.LocationTips;
    RegionCard: Kooboo.KContent.Folders.RegionCard;
    PageElement_CategoryMap: Kooboo.KContent.Folders.PageElement_CategoryMap;
    BlogCategory: Kooboo.KContent.Folders.BlogCategory;
    PageElementBanner: Kooboo.KContent.Folders.PageElementBanner;
    PageElement_Testimonials: Kooboo.KContent.Folders.PageElement_Testimonials;
    OverGofinestera: Kooboo.KContent.Folders.OverGofinestera;
    PageElement_Categories: Kooboo.KContent.Folders.PageElement_Categories;
    EmptyFolder: Kooboo.KContent.Folders.EmptyFolder;
    PageElement_TagCard: Kooboo.KContent.Folders.PageElement_TagCard;
    PlanItem: Kooboo.KContent.Folders.PlanItem;
    Locations: Kooboo.KContent.Folders.Locations;
    Icons: Kooboo.KContent.Folders.Icons;
    Map: Kooboo.KContent.Folders.Map;
    Header: Kooboo.KContent.Folders.Header;
    HeaderItem: Kooboo.KContent.Folders.HeaderItem;
    SubscriptionPlan: Kooboo.KContent.Folders.SubscriptionPlan;
    StepItemAudios: Kooboo.KContent.Folders.StepItemAudios;
    PlaceIcons: Kooboo.KContent.Folders.PlaceIcons;
    ProductItem: Kooboo.KContent.Folders.ProductItem;
    VIdeo: Kooboo.KContent.Folders.VIdeo;
    CommonCard: Kooboo.KContent.Folders.CommonCard;
    StapItem: Kooboo.KContent.Folders.StapItem;
    Footer: Kooboo.KContent.Folders.Footer;
    PageElement_Clients: Kooboo.KContent.Folders.PageElement_Clients;
    CommonFolder: Kooboo.KContent.Folders.CommonFolder;
    HomeFAQ: Kooboo.KContent.FolderTypes.HomeFAQ;
    Plan: Kooboo.KContent.FolderTypes.Plan;
    mapboxConfig: Kooboo.KContent.FolderTypes.mapboxConfig;
    FooterCopyrightBar: Kooboo.KContent.FolderTypes.FooterCopyrightBar;
    IconPage: Kooboo.KContent.FolderTypes.IconPage;
    HomeIntro: Kooboo.KContent.FolderTypes.HomeIntro;
    Regions: Kooboo.KContent.FolderTypes.Regions;
    FaqPage: Kooboo.KContent.FolderTypes.FaqPage;
    HomeVideo: Kooboo.KContent.FolderTypes.HomeVideo;
    HomeLandscape: Kooboo.KContent.FolderTypes.HomeLandscape;
    HomeHeroList: Kooboo.KContent.FolderTypes.HomeHeroList;
    SubscriptionPlanSingle: Kooboo.KContent.FolderTypes.SubscriptionPlanSingle;
    GlobalMetaData: Kooboo.KContent.FolderTypes.GlobalMetaData;
    SearchPage: Kooboo.KContent.FolderTypes.SearchPage;
    EventsPage: Kooboo.KContent.FolderTypes.EventsPage;
    BlogPage: Kooboo.KContent.FolderTypes.BlogPage;
    WebsiteConfigs: Kooboo.KContent.FolderTypes.WebsiteConfigs;
    operators(): KScript.Operators;
  }
...
declare namespace Kooboo.KContent.Types {
  interface LableFolder {
    /** Label TextBox */
    Label: string;
  }

  interface WebsiteConfigs {
    /** Logo AdvancedMediaFile */
    Logo: string;
    /** Search icon AdvancedMediaFile */
    Searchicon: string;
    /** Integrality Icon AdvancedMediaFile */
    IntegralityIcon: string;
    /** Integrality Description TextArea */
    IntegralityDescription: string;
    /** Ambiance Icon AdvancedMediaFile */
    AmbianceIcon: string;
    /** Ambiance Description TextArea */
    AmbianceDescription: string;
    /** DestinationWorthy Icon AdvancedMediaFile */
    DestinationWorthyIcon: string;
    /** Destination Worthy Description TextArea */
    DestinationWorthyDescription: string;
    /** Era Icon AdvancedMediaFile */
    EraIcon: string;
    /** Status Icon AdvancedMediaFile */
    StatusIcon: string;
    /** Accessibility Icon AdvancedMediaFile */
    AccessibilityIcon: string;
    /** Accessibility Description TextArea */
    AccessibilityDescription: string;
    /** Legenda Icon AdvancedMediaFile */
    LegendaIcon: string;
    /** Legenda Description TextArea */
    LegendaDescription: string;
  }

  interface GerelateerdeInfo {
    /** title TextBox */
    title: string;
    /** URL TextBox */
    slug: string;
    /** is free content Switch */
    IsFree: string;
    /** type Selection */
    type: string;
    /** desc TextArea */
  ...
  interface OverGofinestera {
    /** Title TextBox */
    Title: string;
    /** describe TextArea */
    describe: string;
    /** image AdvancedMediaFile */
    image: string;
    /** link TextBox */
    link: string;
  }

  interface PageElement_TagCard {
    /** Title TextBox */
    Title: string;
    /** Image AdvancedMediaFile */
    Image: string;
  ...
  interface PageElement_Audio {
  }

  interface PageElement_2Cards {
    /** TopText TextBox */
    TopText: string;
    /** Title TextBox */
    Title: string;
  ...
  interface CommonButton {
    ...
    /** Url TextBox */
    Url: string;
    /** open Mode (Defaults to the current window) Selection */
    OpenMode: string;
  }
  ...
  interface SubscriptionPlanPrice {
    ...
    /** is_lifetime Switch */
    is_lifetime: string;
    /** stripe_price_id TextBox */
    stripe_price_id: string;
    /** preferred Switch */
    preferred: string;
    /** billing_type RadioBox */
    billing_type: string;
    /** duration Number */
    duration: string;
    /** recurring_interval Selection */
    recurring_interval: string;
    /** amount （amount is in cents） Number */
    amount: string;
    /** tips ValueList */
    tips: string;
    /** folding_tips ValueList */
    folding_tips: string;
  }

  interface HomeLandscapeCard {
    /** Title TextBox */
    Title: string;
    /** Image AdvancedMediaFile */
    Image: string;
    /** IntroText RichEditor */
    IntroText: string;
    /** Location Selection */
    location: string;
  }
  ...
  interface PageElement_ImageAndText {
    /** Title TextBox */
    Title: string;
    /** Description RichEditor */
    Description: string;
  ...
  interface Blog {
    ...
    /** BodyText RichEditor */
    BodyText: string;
    /** FeaturedImage AdvancedMediaFile */
    FeaturedImage: string;
    /** Author TextBox */
    Author: string;
  }
  ...
  interface WebsiteMeta {
    ...
    /** favicon MediaFile */
    favicon: string;
    /** faviconDark MediaFile */
    faviconDark: string;
    /** keywords TextBox */
    keywords: string;
  }

  interface PageElement_Testimonials {
    /** Title TextBox */
    Title: string;
    /** Description RichEditor */
    Description: string;
  ...
  interface Locations {
    ...
    /** Subtext TextBox */
    Subtext: string;
    /** Images(Location data) AdvancedMediaFile */
    TagsImages: string;
    /** Legenda TextBox */
    TagsLegenda: string;
    /** Integrality RadioBox */
    TagsIntegrality: string;
    /** Ambiance RadioBox */
    TagsAmbiance: string;
    /** Destination worthy Switch */
    TagsDestinationWorthy: string;
    /** Era TextBox */
    TagsEra: string;
    /** Status RichEditor */
    TagsStatus: string;
    /** Accessibility Switch */
    TagsAccessibility: string;
    /** Title TextBox */
    Title: string;
    /** Intro text TextArea */
    Introtext: string;
  ...
  interface PageElement_FullLengthImage {
    /** Title TextBox */
    Title: string;
    /** Description RichEditor */
    Description: string;
  ...
  interface PageElement_Clients {
    /** bgType Selection */
    bgType: string;
  }

  interface PageElement_Carrousel {
    /** Title TextBox */
    Title: string;
    /** Description RichEditor */
    Description: string;
  ...
  interface Client {
    ...
    /** time TextBox */
    time: string;
    /** profile AdvancedMediaFile */
    profile: string;
  }

  interface PageElement_SubscribeNewsletter {
    /** bgType Selection */
    bgType: string;
  }
  ...
  interface PageElement_SubscribePromo {
    /** Title TextBox */
    Title: string;
    /** Description RichEditor */
    Description: string;
  ...
  interface PlaceIcons {
    /** icon MediaFile */
    icon: string;
  }

  interface PageElement_MapCards {
    /** Title TextBox */
    Title: string;
    /** Description RichEditor */
    Description: string;
  ...
  interface PageElement_SearchBar {
    /** Title TextBox */
    Title: string;
    /** Description RichEditor */
    Description: string;
  ...
  interface PageElement_TagCardList {
    /** Title TextBox */
    Title: string;
    /** Intro RichEditor */
    Intro: string;
  ...
  interface PageElement_CategoryMap {
    /** BodyText RichEditor */
    BodyText: string;
  }

  interface CMS_KeyValue {
    /** key TextBox */
    key: string;
    /** value TextBox */
    value: string;
  ...
  interface PageElement_Categories {
    /** Title TextBox */
    Title: string;
    /** BodyText RichEditor */
    BodyText: string;
  ...
  interface Places {
    ...
    properties: string;
    /** Additional description (Features:Value) KeyValues */
    additionalDescription: string;
    /** desciption RichEditor */
    desciption: string;
    /** score(Features:Value) KeyValues */
    score: string;
    /** link TextBox */
    link: string;
    /** latitude TextBox */
  ...
  interface PageElement_ContentCard {
    /** Title TextBox */
    Title: string;
    /** Description RichEditor */
    Description: string;
  ...
  interface Events {
    ...
    /** BannerTitle TextBox */
    BannerTitle: string;
    /** BannerIntroText RichEditor */
    BannerIntroText: string;
    /** BannerImage AdvancedMediaFile */
    BannerImage: string;
  }
  ...
  interface Icons {
    ...
    /** Extended Description RichEditor */
    ExtendedDescription: string;
  }

  interface StepItemAudios {
    /** name TextBox */
    name: string;
    /** cover AdvancedMediaFile */
    cover: string;
    /** audio File */
    file: string;
    /** video file File */
  ...
  interface CommonBtn {
    ...
    /** Button Type Selection */
    buttonType: string;
    /** Show box Shadow Switch */
    boxShadow: string;
    /** Show text shadow Switch */
    textShadow: string;
    /** Show border Switch */
    border: string;
    /** button padding size Selection */
    padding: string;
    /** Button Link TextBox */
    link: string;
    /** Open Mode Selection */
 ...
 */
  ...
  interface PageElement_RelatedLocation {
    /** 
var blogs= k.content.blog.all();
var blog1=blogs[0];
var comments=k.content.comment.all();
...
declare namespace Kooboo.KContent.FolderTypes.TemplatePage {
  interface relatedContent {
    banner: Kooboo.KContent.RelationFolders.PageElementBanner;
    MetaData: Kooboo.KContent.RelationFolders.MetaData;
    _: Kooboo.KContent.RelationFolders.PageElement_3Cards;
    SearchBar: Kooboo.KContent.RelationFolders.PageElement_SearchBar;
    Testimonials: Kooboo.KContent.RelationFolders.PageElement_Testimonials;
    _: Kooboo.KContent.RelationFolders.PageElement_2Cards;
    Carrousel: Kooboo.KContent.RelationFolders.PageElement_Carrousel;
    MapCards: Kooboo.KContent.RelationFolders.PageElement_MapCards;
    FAQ: Kooboo.KContent.RelationFolders.PageElement_FAQ;
    SubscribePromo: Kooboo.KContent.RelationFolders.PageElement_SubscribePromo;
    FullLengthImage: Kooboo.KContent.RelationFolders.PageElement_FullLengthImage;
    ImageAndText: Kooboo.KContent.RelationFolders.PageElement_ImageAndText;
    SubscribeNewsletter: Kooboo.KContent.RelationFolders.PageElement_SubscribeNewsletter;
    ContentCard: Kooboo.KContent.RelationFolders.PageElement_ContentCard;
    Categories: Kooboo.KContent.RelationFolders.PageElement_Categories;
    Clients: Kooboo.KContent.RelationFolders.PageElement_Clients;
    TagCardList: Kooboo.KContent.RelationFolders.PageElement_TagCardList;
    Audios: Kooboo.KContent.RelationFolders.PageElement_Audio;
    Video: Kooboo.KContent.RelationFolders.PageElement_Video;
  }

}
declare namespace Kooboo.KContent.MutationTypes {
  interface TemplatePage extends Kooboo.KContent.Types.TemplatePage, Kooboo.KContent.contentTypeBase {
  }

  interface MetaData extends Kooboo.KContent.Types.MetaData, Kooboo.KContent.contentTypeBase {
  }

  interface PlaceCategory extends Kooboo.KContent.Types.PlaceCategory, Kooboo.KContent.contentTypeBase {
  }

  interface PageElement_RelatedLocation extends Kooboo.KContent.Types.CommonFolder, Kooboo.KContent.contentTypeBase {
  }

  interface HomeFAQ extends Kooboo.KContent.Types.HomeFAQ, Kooboo.KContent.contentTypeBase {
  }

  interface PageElement_FAQ extends Kooboo.KContent.Types.PageElement_FAQ, Kooboo.KContent.contentTypeBase {
  }

  interface PlanTip extends Kooboo.KContent.Types.PlanTip, Kooboo.KContent.contentTypeBase {
  }

  interface GerelateerdeInfo extends Kooboo.KContent.Types.GerelateerdeInfo, Kooboo.KContent.contentTypeBase {
  }

  interface Client extends Kooboo.KContent.Types.Client, Kooboo.KContent.contentTypeBase {
  }

  interface LocationRelative extends Kooboo.KContent.Types.LocationRelative, Kooboo.KContent.contentTypeBase {
  }

  interface FAQ extends Kooboo.KContent.Types.FAQ, Kooboo.KContent.contentTypeBase {
  }

  interface PageElement_Video extends Kooboo.KContent.Types.PageElement_Video, Kooboo.KContent.contentTypeBase {
  }

  interface Location extends Kooboo.KContent.Types.Location, Kooboo.KContent.contentTypeBase {
  }

  interface PageElement_2Cards extends Kooboo.KContent.Types.PageElement_2Cards, Kooboo.KContent.contentTypeBase {
  }

  interface Plan extends Kooboo.KContent.Types.Plan, Kooboo.KContent.contentTypeBase {
  }

  interface HomeLandscapeCard extends Kooboo.KContent.Types.HomeLandscapeCard, Kooboo.KContent.contentTypeBase {
  }

  interface Events extends Kooboo.KContent.Types.Events, Kooboo.KContent.contentTypeBase {
  }

  interface mapboxConfig extends Kooboo.KContent.Types.MapboxConfig, Kooboo.KContent.contentTypeBase {
  }

  interface Region extends Kooboo.KContent.Types.Region, Kooboo.KContent.contentTypeBase {
  }

  interface PageElement_SubscribeNewsletter extends Kooboo.KContent.Types.PageElement_SubscribeNewsletter, Kooboo.KContent.contentTypeBase {
  }

  interface CommonBtn extends Kooboo.KContent.Types.CommonBtn, Kooboo.KContent.contentTypeBase {
  }

  interface PageElement_Carrousel extends Kooboo.KContent.Types.PageElement_Carrousel, Kooboo.KContent.contentTypeBase {
  }

  interface PageElement_Audio extends Kooboo.KContent.Types.PageElement_Audio, Kooboo.KContent.contentTypeBase {
  }

  interface WebsiteMeta extends Kooboo.KContent.Types.WebsiteMeta, Kooboo.KContent.contentTypeBase {
  }

  interface FooterCopyrightBar extends Kooboo.KContent.Types.EmptyFolder, Kooboo.KContent.contentTypeBase {
  }

  interface PageElement_FullLengthImage extends Kooboo.KContent.Types.PageElement_FullLengthImage, Kooboo.KContent.contentTypeBase {
  }

  interface PageElement_TagCardList extends Kooboo.KContent.Types.PageElement_TagCardList, Kooboo.KContent.contentTypeBase {
  }

  interface IconPage extends Kooboo.KContent.Types.EmptyFolder, Kooboo.KContent.contentTypeBase {
  }

  interface CMS_KeyValue extends Kooboo.KContent.Types.CMS_KeyValue, Kooboo.KContent.contentTypeBase {
  }

  interface Places extends Kooboo.KContent.Types.Places, Kooboo.KContent.contentTypeBase {
  }

  interface Audio extends Kooboo.KContent.Types.Audio, Kooboo.KContent.contentTypeBase {
  }

  interface PageElement_SubscribePromo extends Kooboo.KContent.Types.PageElement_SubscribePromo, Kooboo.KContent.contentTypeBase {
  }

  interface Steps extends Kooboo.KContent.Types.Steps, Kooboo.KContent.contentTypeBase {
  }

  interface HomeHero extends Kooboo.KContent.Types.HomeHero, Kooboo.KContent.contentTypeBase {
  }

  interface Hotels extends Kooboo.KContent.Types.Hotels, Kooboo.KContent.contentTypeBase {
  }

  interface PageElement_SearchBar extends Kooboo.KContent.Types.PageElement_SearchBar, Kooboo.KContent.contentTypeBase {
  }

  interface Category extends Kooboo.KContent.Types.Category, Kooboo.KContent.contentTypeBase {
  }

  interface CommonButton extends Kooboo.KContent.Types.CommonButton, Kooboo.KContent.contentTypeBase {
  }

  interface Blog extends Kooboo.KContent.Types.Blog, Kooboo.KContent.contentTypeBase {
  }

  interface PageElement_MapCards extends Kooboo.KContent.Types.PageElement_MapCards, Kooboo.KContent.contentTypeBase {
  }

  interface HomeIntro extends Kooboo.KContent.Types.PageElement_TagCardList, Kooboo.KContent.contentTypeBase {
  }

  interface SubscriptionPlanPrice extends Kooboo.KContent.Types.SubscriptionPlanPrice, Kooboo.KContent.contentTypeBase {
  }

  interface FAQItem extends Kooboo.KContent.Types.FAQ, Kooboo.KContent.contentTypeBase {
  }

  interface EmailConfig extends Kooboo.KContent.Types.EmailConfig, Kooboo.KContent.contentTypeBase {
  }

  interface Regions extends Kooboo.KContent.Types.Regions, Kooboo.KContent.contentTypeBase {
  }

  interface PageElement_ContentCard extends Kooboo.KContent.Types.PageElement_ContentCard, Kooboo.KContent.contentTypeBase {
  }

  interface EmbeddedTemplatePages extends Kooboo.KContent.Types.EmptyFolder, Kooboo.KContent.contentTypeBase {
  }

  interface LableFolder extends Kooboo.KContent.Types.LableFolder, Kooboo.KContent.contentTypeBase {
  }

  interface PageElement_ImageAndText extends Kooboo.KContent.Types.PageElement_ImageAndText, Kooboo.KContent.contentTypeBase {
  }

  interface FaqPage extends Kooboo.KContent.Types.EmptyFolder, Kooboo.KContent.contentTypeBase {
  }

  interface HomeVideo extends Kooboo.KContent.Types.HomeVideo, Kooboo.KContent.contentTypeBase {
  }

  interface FooterItem extends Kooboo.KContent.Types.Footer, Kooboo.KContent.contentTypeBase {
  }

  interface PageElement_3Cards extends Kooboo.KContent.Types.PageElement_3Cards, Kooboo.KContent.contentTypeBase {
  }

  interface LocationHighlights extends Kooboo.KContent.Types.LocationHighlights, Kooboo.KContent.contentTypeBase {
  }

  interface HomeLandscape extends Kooboo.KContent.Types.HomeLandscape, Kooboo.KContent.contentTypeBase {
  }

  interface HomeHeroList extends Kooboo.KContent.Types.HomeHeroList, Kooboo.KContent.contentTypeBase {
  }

  interface modules_GoogleCode extends Kooboo.KContent.Types.modules_GoogleCode, Kooboo.KContent.contentTypeBase {
  }

  interface Clients extends Kooboo.KContent.Types.Client, Kooboo.KContent.contentTypeBase {
  }

  interface EventsTable extends Kooboo.KContent.Types.EventsTable, Kooboo.KContent.contentTypeBase {
  }

  interface LocationTips extends Kooboo.KContent.Types.LocationTips, Kooboo.KContent.contentTypeBase {
  }

  interface RegionCard extends Kooboo.KContent.Types.RegionCard, Kooboo.KContent.contentTypeBase {
  }

  interface PageElement_CategoryMap extends Kooboo.KContent.Types.PageElement_CategoryMap, Kooboo.KContent.contentTypeBase {
  }

  interface BlogCategory extends Kooboo.KContent.Types.BlogCategory, Kooboo.KContent.contentTypeBase {
  }

  interface SubscriptionPlanSingle extends Kooboo.KContent.Types.SubscriptionPlan, Kooboo.KContent.contentTypeBase {
  }

  interface GlobalMetaData extends Kooboo.KContent.Types.WebsiteMeta, Kooboo.KContent.contentTypeBase {
  }

  interface SearchPage extends Kooboo.KContent.Types.Events, Kooboo.KContent.contentTypeBase {
  }

  interface PageElementBanner extends Kooboo.KContent.Types.PageElementBanner, Kooboo.KContent.contentTypeBase {
  }

  interface EventsPage extends Kooboo.KContent.Types.Events, Kooboo.KContent.contentTypeBase {
  }

  interface PageElement_Testimonials extends Kooboo.KContent.Types.PageElement_Testimonials, Kooboo.KContent.contentTypeBase {
  }

  interface OverGofinestera extends Kooboo.KContent.Types.OverGofinestera, Kooboo.KContent.contentTypeBase {
  }

  interface PageElement_Categories extends Kooboo.KContent.Types.PageElement_Categories, Kooboo.KContent.contentTypeBase {
  }

  interface EmptyFolder extends Kooboo.KContent.Types.EmptyFolder, Kooboo.KContent.contentTypeBase {
  }

  interface PageElement_TagCard extends Kooboo.KContent.Types.PageElement_TagCard, Kooboo.KContent.contentTypeBase {
  }

  interface BlogPage extends Kooboo.KContent.Types.BlogPage, Kooboo.KContent.contentTypeBase {
  }

  interface WebsiteConfigs extends Kooboo.KContent.Types.WebsiteConfigs, Kooboo.KContent.contentTypeBase {
  }

  interface PlanItem extends Kooboo.KContent.Types.PlanItem, Kooboo.KContent.contentTypeBase {
  }

  interface Locations extends Kooboo.KContent.Types.Locations, Kooboo.KContent.contentTypeBase {
  }

  interface Icons extends Kooboo.KContent.Types.Icons, Kooboo.KContent.contentTypeBase {
  }

  interface Map extends Kooboo.KContent.Types.Map, Kooboo.KContent.contentTypeBase {
  }

  interface Header extends Kooboo.KContent.Types.Header, Kooboo.KContent.contentTypeBase {
  }

  interface HeaderItem extends Kooboo.KContent.Types.Header, Kooboo.KContent.contentTypeBase {
  }

  interface SubscriptionPlan extends Kooboo.KContent.Types.SubscriptionPlan, Kooboo.KContent.contentTypeBase {
  }

  interface StepItemAudios extends Kooboo.KContent.Types.StepItemAudios, Kooboo.KContent.contentTypeBase {
  }

  interface PlaceIcons extends Kooboo.KContent.Types.PlaceIcons, Kooboo.KContent.contentTypeBase {
  }

  interface ProductItem extends Kooboo.KContent.Types.ProductItem, Kooboo.KContent.contentTypeBase {
  }

  interface VIdeo extends Kooboo.KContent.Types.VIdeo, Kooboo.KContent.contentTypeBase {
  }

  interface CommonCard extends Kooboo.KContent.Types.CommonCard, Kooboo.KContent.contentTypeBase {
  }

  interface StapItem extends Kooboo.KContent.Types.StapItem, Kooboo.KContent.contentTypeBase {
  }

  interface Footer extends Kooboo.KContent.Types.Footer, Kooboo.KContent.contentTypeBase {
  }

  interface PageElement_Clients extends Kooboo.KContent.Types.PageElement_Clients, Kooboo.KContent.contentTypeBase {
  }

  interface CommonFolder extends Kooboo.KContent.Types.CommonFolder, Kooboo.KContent.contentTypeBase {
  }

}
declare namespace Kooboo.KContent.FolderTypes {
  interface TemplatePage extends Kooboo.KContent.Types.TemplatePage, Required<Kooboo.KContent.contentTypeBase> {
    banner: Kooboo.KContent.FolderTypes.PageElementBanner[];
    MetaData: Kooboo.KContent.FolderTypes.MetaData[];
    _: Kooboo.KContent.FolderTypes.PageElement_3Cards[];
    SearchBar: Kooboo.KContent.FolderTypes.PageElement_SearchBar[];
    Testimonials: Kooboo.KContent.FolderTypes.PageElement_Testimonials[];
    _: Kooboo.KContent.FolderTypes.PageElement_2Cards[];
    Carrousel: Kooboo.KContent.FolderTypes.PageElement_Carrousel[];
    MapCards: Kooboo.KContent.FolderTypes.PageElement_MapCards[];
    FAQ: Kooboo.KContent.FolderTypes.PageElement_FAQ[];
    SubscribePromo: Kooboo.KContent.FolderTypes.PageElement_SubscribePromo[];
    FullLengthImage: Kooboo.KContent.FolderTypes.PageElement_FullLengthImage[];
    ImageAndText: Kooboo.KContent.FolderTypes.PageElement_ImageAndText[];
    SubscribeNewsletter: Kooboo.KContent.FolderTypes.PageElement_SubscribeNewsletter[];
    ContentCard: Kooboo.KContent.FolderTypes.PageElement_ContentCard[];
    Categories: Kooboo.KContent.FolderTypes.PageElement_Categories[];
    Clients: Kooboo.KContent.FolderTypes.PageElement_Clients[];
    TagCardList: Kooboo.KContent.FolderTypes.PageElement_TagCardList[];
    Audios: Kooboo.KContent.FolderTypes.PageElement_Audio[];
    Video: Kooboo.KContent.FolderTypes.PageElement_Video[];
    relatedContent: Kooboo.KContent.FolderTypes.TemplatePage.relatedContent;
  }

  interface MetaData extends Kooboo.KContent.Types.MetaData, Required<Kooboo.KContent.contentTypeBase> {
  }

  interface PlaceCategory extends Kooboo.KContent.Types.PlaceCategory, Required<Kooboo.KContent.contentTypeBase> {
    Places: Kooboo.KContent.FolderTypes.Places[];
    relatedContent: Kooboo.KContent.FolderTypes.PlaceCategory.relatedContent;
  }

  interface PageElement_RelatedLocation extends Kooboo.KContent.Types.CommonFolder, Required<Kooboo.KContent.contentTypeBase> {
  }

  interface HomeFAQ extends Kooboo.KContent.Types.HomeFAQ, Required<Kooboo.KContent.contentTypeBase> {
    Button: Kooboo.KContent.FolderTypes.CommonBtn[];
    relatedContent: Kooboo.KContent.FolderTypes.HomeFAQ.relatedContent;
  }

  interface PageElement_FAQ extends Kooboo.KContent.Types.PageElement_FAQ, Required<Kooboo.KContent.contentTypeBase> {
    FAQ: Kooboo.KContent.FolderTypes.FAQItem[];
    relatedContent: Kooboo.KContent.FolderTypes.PageElement_FAQ.relatedContent;
  }

  interface PlanTip extends Kooboo.KContent.Types.PlanTip, Required<Kooboo.KContent.contentTypeBase> {
  }

  interface GerelateerdeInfo extends Kooboo.KContent.Types.GerelateerdeInfo, Required<Kooboo.KContent.contentTypeBase> {
    Banner: Kooboo.KContent.FolderTypes.PageElementBanner[];
    MetaData: Kooboo.KContent.FolderTypes.MetaData[];
    Audios: Kooboo.KContent.FolderTypes.Audio[];
    relatedContent: Kooboo.KContent.FolderTypes.GerelateerdeInfo.relatedContent;
  }

  interface Client extends Kooboo.KContent.Types.Client, Required<Kooboo.KContent.contentTypeBase> {
  }

  interface LocationRelative extends Kooboo.KContent.Types.LocationRelative, Required<Kooboo.KContent.contentTypeBase> {
  }

  interface FAQ extends Kooboo.KContent.Types.FAQ, Required<Kooboo.KContent.contentTypeBase> {
  }

  interface PageElement_Video extends Kooboo.KContent.Types.PageElement_Video, Required<Kooboo.KContent.contentTypeBase> {
  }

  interface Location extends Kooboo.KContent.Types.Location, Required<Kooboo.KContent.contentTypeBase> {
  }

  interface PageElement_2Cards extends Kooboo.KContent.Types.PageElement_2Cards, Required<Kooboo.KContent.contentTypeBase> {
    Cards: Kooboo.KContent.FolderTypes.CommonCard[];
    relatedContent: Kooboo.KContent.FolderTypes.PageElement_2Cards.relatedContent;
  }

  interface Plan extends Kooboo.KContent.Types.Plan, Required<Kooboo.KContent.contentTypeBase> {
    tips: Kooboo.KContent.FolderTypes.PlanTip[];
    items: Kooboo.KContent.FolderTypes.PlanItem[];
    relatedContent: Kooboo.KContent.FolderTypes.Plan.relatedContent;
  }

  interface HomeLandscapeCard extends Kooboo.KContent.Types.HomeLandscapeCard, Required<Kooboo.KContent.contentTypeBase> {
  }

  interface Events extends Kooboo.KContent.Types.Events, Required<Kooboo.KContent.contentTypeBase> {
  }

  interface mapboxConfig extends Kooboo.KContent.Types.MapboxConfig, Required<Kooboo.KContent.contentTypeBase> {
  }

  interface Region extends Kooboo.KContent.Types.Region, Required<Kooboo.KContent.contentTypeBase> {
    ContentCard: Kooboo.KContent.FolderTypes.PageElement_ContentCard[];
    FullLengthImage: Kooboo.KContent.FolderTypes.PageElement_FullLengthImage[];
    ImageAndText: Kooboo.KContent.FolderTypes.PageElement_ImageAndText[];
    SubscribeNewsletter: Kooboo.KContent.FolderTypes.PageElement_SubscribeNewsletter[];
    Clients: Kooboo.KContent.FolderTypes.PageElement_Clients[];
    MetaData: Kooboo.KContent.FolderTypes.MetaData[];
    relatedContent: Kooboo.KContent.FolderTypes.Region.relatedContent;
  }

  interface PageElement_SubscribeNewsletter extends Kooboo.KContent.Types.PageElement_SubscribeNewsletter, Required<Kooboo.KContent.contentTypeBase> {
  }

  interface CommonBtn extends Kooboo.KContent.Types.CommonBtn, Required<Kooboo.KContent.contentTypeBase> {
  }

  interface PageElement_Carrousel extends Kooboo.KContent.Types.PageElement_Carrousel, Required<Kooboo.KContent.contentTypeBase> {
    Products: Kooboo.KContent.FolderTypes.ProductItem[];
    relatedContent: Kooboo.KContent.FolderTypes.PageElement_Carrousel.relatedContent;
  }

  interface PageElement_Audio extends Kooboo.KContent.Types.PageElement_Audio, Required<Kooboo.KContent.contentTypeBase> {
    Audios: Kooboo.KContent.FolderTypes.Audio[];
    relatedContent: Kooboo.KContent.FolderTypes.PageElement_Audio.relatedContent;
  }

  interface WebsiteMeta extends Kooboo.KContent.Types.WebsiteMeta, Required<Kooboo.KContent.contentTypeBase> {
  }

  interface FooterCopyrightBar extends Kooboo.KContent.Types.EmptyFolder, Required<Kooboo.KContent.contentTypeBase> {
    Links: Kooboo.KContent.FolderTypes.FooterItem[];
    relatedContent: Kooboo.KContent.FolderTypes.FooterCopyrightBar.relatedContent;
  }

  interface PageElement_FullLengthImage extends Kooboo.KContent.Types.PageElement_FullLengthImage, Required<Kooboo.KContent.contentTypeBase> {
    Button: Kooboo.KContent.FolderTypes.CommonBtn[];
    relatedContent: Kooboo.KContent.FolderTypes.PageElement_FullLengthImage.relatedContent;
  }

  interface PageElement_TagCardList extends Kooboo.KContent.Types.PageElement_TagCardList, Required<Kooboo.KContent.contentTypeBase> {
    Card: Kooboo.KContent.FolderTypes.PageElement_TagCard[];
    relatedContent: Kooboo.KContent.FolderTypes.PageElement_TagCardList.relatedContent;
  }

  interface IconPage extends Kooboo.KContent.Types.EmptyFolder, Required<Kooboo.KContent.contentTypeBase> {
    Banner: Kooboo.KContent.FolderTypes.PageElementBanner[];
    MetaData: Kooboo.KContent.FolderTypes.MetaData[];
    relatedContent: Kooboo.KContent.FolderTypes.IconPage.relatedContent;
  }

  interface CMS_KeyValue extends Kooboo.KContent.Types.CMS_KeyValue, Required<Kooboo.KContent.contentTypeBase> {
  }

  interface Places extends Kooboo.KContent.Types.Places, Required<Kooboo.KContent.contentTypeBase> {
    icon: Kooboo.KContent.FolderTypes.PlaceIcons[];
    category: Kooboo.KContent.FolderTypes.PlaceCategory[];
    relatedContent: Kooboo.KContent.FolderTypes.Places.relatedContent;
  }

  interface Audio extends Kooboo.KContent.Types.Audio, Required<Kooboo.KContent.contentTypeBase> {
  }

  interface PageElement_SubscribePromo extends Kooboo.KContent.Types.PageElement_SubscribePromo, Required<Kooboo.KContent.contentTypeBase> {
  }

  interface Steps extends Kooboo.KContent.Types.Steps, Required<Kooboo.KContent.contentTypeBase> {
    Btns: Kooboo.KContent.FolderTypes.CommonButton[];
    Step: Kooboo.KContent.FolderTypes.StapItem[];
    relatedContent: Kooboo.KContent.FolderTypes.Steps.relatedContent;
  }

  interface HomeHero extends Kooboo.KContent.Types.HomeHero, Required<Kooboo.KContent.contentTypeBase> {
  }

  interface Hotels extends Kooboo.KContent.Types.Hotels, Required<Kooboo.KContent.contentTypeBase> {
  }

  interface PageElement_SearchBar extends Kooboo.KContent.Types.PageElement_SearchBar, Required<Kooboo.KContent.contentTypeBase> {
  }

  interface Category extends Kooboo.KContent.Types.Category, Required<Kooboo.KContent.contentTypeBase> {
  }

  interface CommonButton extends Kooboo.KContent.Types.CommonButton, Required<Kooboo.KContent.contentTypeBase> {
  }

  interface Blog extends Kooboo.KContent.Types.Blog, Required<Kooboo.KContent.contentTypeBase> {
    Banner: Kooboo.KContent.FolderTypes.PageElementBanner[];
    MetaData: Kooboo.KContent.FolderTypes.MetaData[];
    Category: Kooboo.KContent.FolderTypes.BlogCategory[];
    RelatedArticles: Kooboo.KContent.FolderTypes.Blog[];
    relatedContent: Kooboo.KContent.FolderTypes.Blog.relatedContent;
  }

  interface PageElement_MapCards extends Kooboo.KContent.Types.PageElement_MapCards, Required<Kooboo.KContent.contentTypeBase> {
    Products: Kooboo.KContent.FolderTypes.ProductItem[];
    relatedContent: Kooboo.KContent.FolderTypes.PageElement_MapCards.relatedContent;
  }

  interface HomeIntro extends Kooboo.KContent.Types.PageElement_TagCardList, Required<Kooboo.KContent.contentTypeBase> {
    Card: Kooboo.KContent.FolderTypes.PageElement_TagCard[];
    relatedContent: Kooboo.KContent.FolderTypes.HomeIntro.relatedContent;
  }

  interface SubscriptionPlanPrice extends Kooboo.KContent.Types.SubscriptionPlanPrice, Required<Kooboo.KContent.contentTypeBase> {
  }

  interface FAQItem extends Kooboo.KContent.Types.FAQ, Required<Kooboo.KContent.contentTypeBase> {
  }

  interface EmailConfig extends Kooboo.KContent.Types.EmailConfig, Required<Kooboo.KContent.contentTypeBase> {
  }

  interface Regions extends Kooboo.KContent.Types.Regions, Required<Kooboo.KContent.contentTypeBase> {
    MetaData: Kooboo.KContent.FolderTypes.MetaData[];
    ContentCard: Kooboo.KContent.FolderTypes.PageElement_ContentCard[];
    FullLengthImage: Kooboo.KContent.FolderTypes.PageElement_FullLengthImage[];
    ImageAndText: Kooboo.KContent.FolderTypes.PageElement_ImageAndText[];
    SubscribeNewsletter: Kooboo.KContent.FolderTypes.PageElement_SubscribeNewsletter[];
    Banner: Kooboo.KContent.FolderTypes.PageElementBanner[];
    relatedContent: Kooboo.KContent.FolderTypes.Regions.relatedContent;
  }

  interface PageElement_ContentCard extends Kooboo.KContent.Types.PageElement_ContentCard, Required<Kooboo.KContent.contentTypeBase> {
    Cards: Kooboo.KContent.FolderTypes.RegionCard[];
    Button: Kooboo.KContent.FolderTypes.CommonBtn[];
    relatedContent: Kooboo.KContent.FolderTypes.PageElement_ContentCard.relatedContent;
  }

  interface EmbeddedTemplatePages extends Kooboo.KContent.Types.EmptyFolder, Required<Kooboo.KContent.contentTypeBase> {
    banner: Kooboo.KContent.FolderTypes.PageElementBanner[];
    MetaData: Kooboo.KContent.FolderTypes.WebsiteMeta[];
    _: Kooboo.KContent.FolderTypes.PageElement_3Cards[];
    SearchBar: Kooboo.KContent.FolderTypes.PageElement_SearchBar[];
    Testimonials: Kooboo.KContent.FolderTypes.PageElement_Testimonials[];
    _: Kooboo.KContent.FolderTypes.PageElement_2Cards[];
    ...
    Clients: Kooboo.KContent.FolderTypes.PageElement_Clients[];
    TagCardList: Kooboo.KContent.FolderTypes.PageElement_TagCardList[];
    RelatedLocation: Kooboo.KContent.FolderTypes.PageElement_RelatedLocation[];
    Map: Kooboo.KContent.FolderTypes.PageElement_CategoryMap[];
    Audios: Kooboo.KContent.FolderTypes.PageElement_Audio[];
    relatedContent: Kooboo.KContent.FolderTypes.EmbeddedTemplatePages.relatedContent;
  }

  interface LableFolder extends Kooboo.KContent.Types.LableFolder, Required<Kooboo.KContent.contentTypeBase> {
  }

  interface PageElement_ImageAndText extends Kooboo.KContent.Types.PageElement_ImageAndText, Required<Kooboo.KContent.contentTypeBase> {
    Button: Kooboo.KContent.FolderTypes.CommonBtn[];
    relatedContent: Kooboo.KContent.FolderTypes.PageElement_ImageAndText.relatedContent;
  }

  interface FaqPage extends Kooboo.KContent.Types.EmptyFolder, Required<Kooboo.KContent.contentTypeBase> {
    Banner: Kooboo.KContent.FolderTypes.PageElementBanner[];
    Button: Kooboo.KContent.FolderTypes.CommonBtn[];
    MetaData: Kooboo.KContent.FolderTypes.MetaData[];
    relatedContent: Kooboo.KContent.FolderTypes.FaqPage.relatedContent;
  }

  interface HomeVideo extends Kooboo.KContent.Types.HomeVideo, Required<Kooboo.KContent.contentTypeBase> {
  }

  interface FooterItem extends Kooboo.KContent.Types.Footer, Required<Kooboo.KContent.contentTypeBase> {
  }

  interface PageElement_3Cards extends Kooboo.KContent.Types.PageElement_3Cards, Required<Kooboo.KContent.contentTypeBase> {
    Products: Kooboo.KContent.FolderTypes.ProductItem[];
    relatedContent: Kooboo.KContent.FolderTypes.PageElement_3Cards.relatedContent;
  }

  interface LocationHighlights extends Kooboo.KContent.Types.LocationHighlights, Required<Kooboo.KContent.contentTypeBase> {
  }

  interface HomeLandscape extends Kooboo.KContent.Types.HomeLandscape, Required<Kooboo.KContent.contentTypeBase> {
    Card: Kooboo.KContent.FolderTypes.HomeLandscapeCard[];
    relatedContent: Kooboo.KContent.FolderTypes.HomeLandscape.relatedContent;
  }

  interface HomeHeroList extends Kooboo.KContent.Types.HomeHeroList, Required<Kooboo.KContent.contentTypeBase> {
    Heros: Kooboo.KContent.FolderTypes.HomeHero[];
    Buttons: Kooboo.KContent.FolderTypes.CommonBtn[];
    relatedContent: Kooboo.KContent.FolderTypes.HomeHeroList.relatedContent;
  }

  interface modules_GoogleCode extends Kooboo.KContent.Types.modules_GoogleCode, Required<Kooboo.KContent.contentTypeBase> {
  }

  interface Clients extends Kooboo.KContent.Types.Client, Required<Kooboo.KContent.contentTypeBase> {
  }

  interface EventsTable extends Kooboo.KContent.Types.EventsTable, Required<Kooboo.KContent.contentTypeBase> {
  }

  interface LocationTips extends Kooboo.KContent.Types.LocationTips, Required<Kooboo.KContent.contentTypeBase> {
  }

  interface RegionCard extends Kooboo.KContent.Types.RegionCard, Required<Kooboo.KContent.contentTypeBase> {
  }

  interface PageElement_CategoryMap extends Kooboo.KContent.Types.PageElement_CategoryMap, Required<Kooboo.KContent.contentTypeBase> {
  }

  interface BlogCategory extends Kooboo.KContent.Types.BlogCategory, Required<Kooboo.KContent.contentTypeBase> {
    Blog: Kooboo.KContent.FolderTypes.Blog[];
    relatedContent: Kooboo.KContent.FolderTypes.BlogCategory.relatedContent;
  }

  interface SubscriptionPlanSingle extends Kooboo.KContent.Types.SubscriptionPlan, Required<Kooboo.KContent.contentTypeBase> {
    plan_price: Kooboo.KContent.FolderTypes.SubscriptionPlanPrice[];
    relatedContent: Kooboo.KContent.FolderTypes.SubscriptionPlanSingle.relatedContent;
  }

  interface GlobalMetaData extends Kooboo.KContent.Types.WebsiteMeta, Required<Kooboo.KContent.contentTypeBase> {
  }

  interface SearchPage extends Kooboo.KContent.Types.Events, Required<Kooboo.KContent.contentTypeBase> {
    BannerButton: Kooboo.KContent.FolderTypes.CommonBtn[];
    MetaData: Kooboo.KContent.FolderTypes.MetaData[];
    relatedContent: Kooboo.KContent.FolderTypes.SearchPage.relatedContent;
  }

  interface PageElementBanner extends Kooboo.KContent.Types.PageElementBanner, Required<Kooboo.KContent.contentTypeBase> {
    Button: Kooboo.KContent.FolderTypes.CommonBtn[];
    relatedContent: Kooboo.KContent.FolderTypes.PageElementBanner.relatedContent;
  }

  interface EventsPage extends Kooboo.KContent.Types.Events, Required<Kooboo.KContent.contentTypeBase> {
    BannerButton: Kooboo.KContent.FolderTypes.CommonBtn[];
    MetaData: Kooboo.KContent.FolderTypes.MetaData[];
    relatedContent: Kooboo.KContent.FolderTypes.EventsPage.relatedContent;
  }

  interface PageElement_Testimonials extends Kooboo.KContent.Types.PageElement_Testimonials, Required<Kooboo.KContent.contentTypeBase> {
    Testimonials: Kooboo.KContent.FolderTypes.Clients[];
    relatedContent: Kooboo.KContent.FolderTypes.PageElement_Testimonials.relatedContent;
  }

  interface OverGofinestera extends Kooboo.KContent.Types.OverGofinestera, Required<Kooboo.KContent.contentTypeBase> {
  }

  interface PageElement_Categories extends Kooboo.KContent.Types.PageElement_Categories, Required<Kooboo.KContent.contentTypeBase> {
  }

  interface EmptyFolder extends Kooboo.KContent.Types.EmptyFolder, Required<Kooboo.KContent.contentTypeBase> {
  }

  interface PageElement_TagCard extends Kooboo.KContent.Types.PageElement_TagCard, Required<Kooboo.KContent.contentTypeBase> {
  }

  interface BlogPage extends Kooboo.KContent.Types.BlogPage, Required<Kooboo.KContent.contentTypeBase> {
    Banner: Kooboo.KContent.FolderTypes.PageElementBanner[];
    MetaData: Kooboo.KContent.FolderTypes.MetaData[];
    relatedContent: Kooboo.KContent.FolderTypes.BlogPage.relatedContent;
  }

  interface WebsiteConfigs extends Kooboo.KContent.Types.WebsiteConfigs, Required<Kooboo.KContent.contentTypeBase> {
  }

  interface PlanItem extends Kooboo.KContent.Types.PlanItem, Required<Kooboo.KContent.contentTypeBase> {
  }

  interface Locations extends Kooboo.KContent.Types.Locations, Required<Kooboo.KContent.contentTypeBase> {
  }

  interface Icons extends Kooboo.KContent.Types.Icons, Required<Kooboo.KContent.contentTypeBase> {
  }

  interface Map extends Kooboo.KContent.Types.Map, Required<Kooboo.KContent.contentTypeBase> {
  }

  interface Header extends Kooboo.KContent.Types.Header, Required<Kooboo.KContent.contentTypeBase> {
    childs: Kooboo.KContent.FolderTypes.HeaderItem[];
    relatedContent: Kooboo.KContent.FolderTypes.Header.relatedContent;
  }

  interface HeaderItem extends Kooboo.KContent.Types.Header, Required<Kooboo.KContent.contentTypeBase> {
  }

  interface SubscriptionPlan extends Kooboo.KContent.Types.SubscriptionPlan, Required<Kooboo.KContent.contentTypeBase> {
    plan_price: Kooboo.KContent.FolderTypes.SubscriptionPlanPrice[];
    relatedContent: Kooboo.KContent.FolderTypes.SubscriptionPlan.relatedContent;
  }

  interface StepItemAudios extends Kooboo.KContent.Types.StepItemAudios, Required<Kooboo.KContent.contentTypeBase> {
  }

  interface PlaceIcons extends Kooboo.KContent.Types.PlaceIcons, Required<Kooboo.KContent.contentTypeBase> {
    Places: Kooboo.KContent.FolderTypes.Places[];
    relatedContent: Kooboo.KContent.FolderTypes.PlaceIcons.relatedContent;
  }

  interface ProductItem extends Kooboo.KContent.Types.ProductItem, Required<Kooboo.KContent.contentTypeBase> {
  }

  interface VIdeo extends Kooboo.KContent.Types.VIdeo, Required<Kooboo.KContent.contentTypeBase> {
  }

  interface CommonCard extends Kooboo.KContent.Types.CommonCard, Required<Kooboo.KContent.contentTypeBase> {
  }

  interface StapItem extends Kooboo.KContent.Types.StapItem, Required<Kooboo.KContent.contentTypeBase> {
    Medias: Kooboo.KContent.FolderTypes.StepItemAudios[];
    relatedContent: Kooboo.KContent.FolderTypes.StapItem.relatedContent;
  }

  interface Footer extends Kooboo.KContent.Types.Footer, Required<Kooboo.KContent.contentTypeBase> {
    childs: Kooboo.KContent.FolderTypes.FooterItem[];
    relatedContent: Kooboo.KContent.FolderTypes.Footer.relatedContent;
  }

  interface PageElement_Clients extends Kooboo.KContent.Types.PageElement_Clients, Required<Kooboo.KContent.contentTypeBase> {
  }

  interface CommonFolder extends Kooboo.KContent.Types.CommonFolder, Required<Kooboo.KContent.contentTypeBase> {
  }

}
declare namespace Kooboo.KContent.FolderTypes.PlaceCategory {
  interface relatedContent {
    Places: Kooboo.KContent.RelationFolders.Places;
  }

}
declare namespace Kooboo.KContent.FolderTypes.HomeFAQ {
  interface relatedContent {
    Button: Kooboo.KContent.RelationFolders.CommonBtn;
  }

}
declare namespace Kooboo.KContent.FolderTypes.PageElement_FAQ {
  interface relatedContent {
    FAQ: Kooboo.KContent.RelationFolders.FAQItem;
  }

}
declare namespace Kooboo.KContent.FolderTypes.GerelateerdeInfo {
  interface relatedContent {
    Banner: Kooboo.KContent.RelationFolders.PageElementBanner;
    MetaData: Kooboo.KContent.RelationFolders.MetaData;
    Audios: Kooboo.KContent.RelationFolders.Audio;
  }

}
declare namespace Kooboo.KContent.FolderTypes.PageElement_2Cards {
  interface relatedContent {
    Cards: Kooboo.KContent.RelationFolders.CommonCard;
  }

}
declare namespace Kooboo.KContent.FolderTypes.Plan {
  interface relatedContent {
    tips: Kooboo.KContent.RelationFolders.PlanTip;
    items: Kooboo.KContent.RelationFolders.PlanItem;
  }

}
declare namespace Kooboo.KContent.FolderTypes.Region {
  interface relatedContent {
    ContentCard: Kooboo.KContent.RelationFolders.PageElement_ContentCard;
    FullLengthImage: Kooboo.KContent.RelationFolders.PageElement_FullLengthImage;
    ImageAndText: Kooboo.KContent.RelationFolders.PageElement_ImageAndText;
...
declare namespace Kooboo.KContent.FolderTypes.PageElement_Carrousel {
  interface relatedContent {
    Products: Kooboo.KContent.RelationFolders.ProductItem;
  }

}
declare namespace Kooboo.KContent.FolderTypes.PageElement_Audio {
  interface relatedContent {
    Audios: Kooboo.KContent.RelationFolders.Audio;
  }

}
declare namespace Kooboo.KContent.FolderTypes.FooterCopyrightBar {
  interface relatedContent {
    Links: Kooboo.KContent.RelationFolders.FooterItem;
  }

}
declare namespace Kooboo.KContent.FolderTypes.PageElement_FullLengthImage {
  interface relatedContent {
    Button: Kooboo.KContent.RelationFolders.CommonBtn;
  }

}
declare namespace Kooboo.KContent.FolderTypes.PageElement_TagCardList {
  interface relatedContent {
    Card: Kooboo.KContent.RelationFolders.PageElement_TagCard;
  }

}
declare namespace Kooboo.KContent.FolderTypes.IconPage {
  interface relatedContent {
    Banner: Kooboo.KContent.RelationFolders.PageElementBanner;
    MetaData: Kooboo.KContent.RelationFolders.MetaData;
  }
...
declare namespace Kooboo.KContent.FolderTypes.Places {
  interface relatedContent {
    icon: Kooboo.KContent.RelationFolders.PlaceIcons;
    category: Kooboo.KContent.RelationFolders.PlaceCategory;
  }

}
declare namespace Kooboo.KContent.FolderTypes.Steps {
  interface relatedContent {
    Btns: Kooboo.KContent.RelationFolders.CommonButton;
    Step: Kooboo.KContent.RelationFolders.StapItem;
  }

}
declare namespace Kooboo.KContent.FolderTypes.Blog {
  interface relatedContent {
    Banner: Kooboo.KContent.RelationFolders.PageElementBanner;
    MetaData: Kooboo.KContent.RelationFolders.MetaData;
    Category: Kooboo.KContent.RelationFolders.BlogCategory;
    RelatedArticles: Kooboo.KContent.RelationFolders.Blog;
  }

}
declare namespace Kooboo.KContent.FolderTypes.PageElement_MapCards {
  interface relatedContent {
    Products: Kooboo.KContent.RelationFolders.ProductItem;
  }

}
declare namespace Kooboo.KContent.FolderTypes.HomeIntro {
  interface relatedContent {
    Card: Kooboo.KContent.RelationFolders.PageElement_TagCard;
  }

}
declare namespace Kooboo.KContent.FolderTypes.Regions {
  interface relatedContent {
    MetaData: Kooboo.KContent.RelationFolders.MetaData;
    ContentCard: Kooboo.KContent.RelationFolders.PageElement_ContentCard;
    FullLengthImage: Kooboo.KContent.RelationFolders.PageElement_FullLengthImage;
...
declare namespace Kooboo.KContent.FolderTypes.PageElement_ContentCard {
  interface relatedContent {
    Cards: Kooboo.KContent.RelationFolders.RegionCard;
    Button: Kooboo.KContent.RelationFolders.CommonBtn;
  }

}
declare namespace Kooboo.KContent.FolderTypes.EmbeddedTemplatePages {
  interface relatedContent {
    banner: Kooboo.KContent.RelationFolders.PageElementBanner;
    MetaData: Kooboo.KContent.RelationFolders.WebsiteMeta;
    _: Kooboo.KContent.RelationFolders.PageElement_3Cards;
    SearchBar: Kooboo.KContent.RelationFolders.PageElement_SearchBar;
    Testimonials: Kooboo.KContent.RelationFolders.PageElement_Testimonials;
    _: Kooboo.KContent.RelationFolders.PageElement_2Cards;
    ...
    Clients: Kooboo.KContent.RelationFolders.PageElement_Clients;
    TagCardList: Kooboo.KContent.RelationFolders.PageElement_TagCardList;
    RelatedLocation: Kooboo.KContent.RelationFolders.PageElement_RelatedLocation;
    Map: Kooboo.KContent.RelationFolders.PageElement_CategoryMap;
    Audios: Kooboo.KContent.RelationFolders.PageElement_Audio;
  }

}
declare namespace Kooboo.KContent.FolderTypes.PageElement_ImageAndText {
  interface relatedContent {
    Button: Kooboo.KContent.RelationFolders.CommonBtn;
  }

}
declare namespace Kooboo.KContent.FolderTypes.FaqPage {
  interface relatedContent {
    Banner: Kooboo.KContent.RelationFolders.PageElementBanner;
    Button: Kooboo.KContent.RelationFolders.CommonBtn;
    MetaData: Kooboo.KContent.RelationFolders.MetaData;
...
declare namespace Kooboo.KContent.FolderTypes.PageElement_3Cards {
  interface relatedContent {
    Products: Kooboo.KContent.RelationFolders.ProductItem;
  }

}
declare namespace Kooboo.KContent.FolderTypes.HomeLandscape {
  interface relatedContent {
    Card: Kooboo.KContent.RelationFolders.HomeLandscapeCard;
  }

}
declare namespace Kooboo.KContent.FolderTypes.HomeHeroList {
  interface relatedContent {
    Heros: Kooboo.KContent.RelationFolders.HomeHero;
    Buttons: Kooboo.KContent.RelationFolders.CommonBtn;
  }

}
declare namespace Kooboo.KContent.FolderTypes.BlogCategory {
  interface relatedContent {
    Blog: Kooboo.KContent.RelationFolders.Blog;
  }

}
declare namespace Kooboo.KContent.FolderTypes.SubscriptionPlanSingle {
  interface relatedContent {
    plan_price: Kooboo.KContent.RelationFolders.SubscriptionPlanPrice;
  }

}
declare namespace Kooboo.KContent.FolderTypes.SearchPage {
  interface relatedContent {
    BannerButton: Kooboo.KContent.RelationFolders.CommonBtn;
    MetaData: Kooboo.KContent.RelationFolders.MetaData;
  }

}
declare namespace Kooboo.KContent.FolderTypes.PageElementBanner {
  interface relatedContent {
    Button: Kooboo.KContent.RelationFolders.CommonBtn;
  }

}
declare namespace Kooboo.KContent.FolderTypes.EventsPage {
  interface relatedContent {
    BannerButton: Kooboo.KContent.RelationFolders.CommonBtn;
    MetaData: Kooboo.KContent.RelationFolders.MetaData;
  }
...
declare namespace Kooboo.KContent.FolderTypes.PageElement_Testimonials {
  interface relatedContent {
    Testimonials: Kooboo.KContent.RelationFolders.Clients;
  }

}
declare namespace Kooboo.KContent.FolderTypes.BlogPage {
  interface relatedContent {
    Banner: Kooboo.KContent.RelationFolders.PageElementBanner;
    MetaData: Kooboo.KContent.RelationFolders.MetaData;
  }
...
declare namespace Kooboo.KContent.FolderTypes.Header {
  interface relatedContent {
    childs: Kooboo.KContent.RelationFolders.HeaderItem;
  }

}
declare namespace Kooboo.KContent.FolderTypes.SubscriptionPlan {
  interface relatedContent {
    plan_price: Kooboo.KContent.RelationFolders.SubscriptionPlanPrice;
  }

}
declare namespace Kooboo.KContent.FolderTypes.PlaceIcons {
  interface relatedContent {
    Places: Kooboo.KContent.RelationFolders.Places;
  }

}
declare namespace Kooboo.KContent.FolderTypes.StapItem {
  interface relatedContent {
    Medias: Kooboo.KContent.RelationFolders.StepItemAudios;
  }

}
declare namespace Kooboo.KContent.FolderTypes.Footer {
  interface relatedContent {
    childs: Kooboo.KContent.RelationFolders.FooterItem;
  }

}
declare namespace Kooboo.KContent.Folders {
  interface TemplatePage extends Kooboo.KContent.folderBase<Kooboo.KContent.FolderTypes.TemplatePage,Kooboo.KContent.MutationTypes.TemplatePage> {
  }

  interface MetaData extends Kooboo.KContent.folderBase<Kooboo.KContent.FolderTypes.MetaData,Kooboo.KContent.MutationTypes.MetaData> {
  }

  interface PlaceCategory extends Kooboo.KContent.folderBase<Kooboo.KContent.FolderTypes.PlaceCategory,Kooboo.KContent.MutationTypes.PlaceCategory> {
  }

  interface PageElement_RelatedLocation extends Kooboo.KContent.folderBase<Kooboo.KContent.FolderTypes.PageElement_RelatedLocation,Kooboo.KContent.MutationTypes.PageElement_RelatedLocation> {
  }

  interface PageElement_FAQ extends Kooboo.KContent.folderBase<Kooboo.KContent.FolderTypes.PageElement_FAQ,Kooboo.KContent.MutationTypes.PageElement_FAQ> {
  }

  interface PlanTip extends Kooboo.KContent.folderBase<Kooboo.KContent.FolderTypes.PlanTip,Kooboo.KContent.MutationTypes.PlanTip> {
  }

  interface GerelateerdeInfo extends Kooboo.KContent.folderBase<Kooboo.KContent.FolderTypes.GerelateerdeInfo,Kooboo.KContent.MutationTypes.GerelateerdeInfo> {
  }

  interface Client extends Kooboo.KContent.folderBase<Kooboo.KContent.FolderTypes.Client,Kooboo.KContent.MutationTypes.Client> {
  }

  interface LocationRelative extends Kooboo.KContent.folderBase<Kooboo.KContent.FolderTypes.LocationRelative,Kooboo.KContent.MutationTypes.LocationRelative> {
  }

  interface FAQ extends Kooboo.KContent.folderBase<Kooboo.KContent.FolderTypes.FAQ,Kooboo.KContent.MutationTypes.FAQ> {
  }

  interface PageElement_Video extends Kooboo.KContent.folderBase<Kooboo.KContent.FolderTypes.PageElement_Video,Kooboo.KContent.MutationTypes.PageElement_Video> {
  }

  interface Location extends Kooboo.KContent.folderBase<Kooboo.KContent.FolderTypes.Location,Kooboo.KContent.MutationTypes.Location> {
  }

  interface PageElement_2Cards extends Kooboo.KContent.folderBase<Kooboo.KContent.FolderTypes.PageElement_2Cards,Kooboo.KContent.MutationTypes.PageElement_2Cards> {
  }

  interface HomeLandscapeCard extends Kooboo.KContent.folderBase<Kooboo.KContent.FolderTypes.HomeLandscapeCard,Kooboo.KContent.MutationTypes.HomeLandscapeCard> {
  }

  interface Events extends Kooboo.KContent.folderBase<Kooboo.KContent.FolderTypes.Events,Kooboo.KContent.MutationTypes.Events> {
  }

  interface Region extends Kooboo.KContent.folderBase<Kooboo.KContent.FolderTypes.Region,Kooboo.KContent.MutationTypes.Region> {
  }

  interface PageElement_SubscribeNewsletter extends Kooboo.KContent.folderBase<Kooboo.KContent.FolderTypes.PageElement_SubscribeNewsletter,Kooboo.KContent.MutationTypes.PageElement_SubscribeNewsletter> {
  }

  interface CommonBtn extends Kooboo.KContent.folderBase<Kooboo.KContent.FolderTypes.CommonBtn,Kooboo.KContent.MutationTypes.CommonBtn> {
  }

  interface PageElement_Carrousel extends Kooboo.KContent.folderBase<Kooboo.KContent.FolderTypes.PageElement_Carrousel,Kooboo.KContent.MutationTypes.PageElement_Carrousel> {
  }

  interface PageElement_Audio extends Kooboo.KContent.folderBase<Kooboo.KContent.FolderTypes.PageElement_Audio,Kooboo.KContent.MutationTypes.PageElement_Audio> {
  }

  interface WebsiteMeta extends Kooboo.KContent.folderBase<Kooboo.KContent.FolderTypes.WebsiteMeta,Kooboo.KContent.MutationTypes.WebsiteMeta> {
  }

  interface PageElement_FullLengthImage extends Kooboo.KContent.folderBase<Kooboo.KContent.FolderTypes.PageElement_FullLengthImage,Kooboo.KContent.MutationTypes.PageElement_FullLengthImage> {
  }

  interface PageElement_TagCardList extends Kooboo.KContent.folderBase<Kooboo.KContent.FolderTypes.PageElement_TagCardList,Kooboo.KContent.MutationTypes.PageElement_TagCardList> {
  }

  interface CMS_KeyValue extends Kooboo.KContent.folderBase<Kooboo.KContent.FolderTypes.CMS_KeyValue,Kooboo.KContent.MutationTypes.CMS_KeyValue> {
  }

  interface Places extends Kooboo.KContent.folderBase<Kooboo.KContent.FolderTypes.Places,Kooboo.KContent.MutationTypes.Places> {
  }

  interface Audio extends Kooboo.KContent.folderBase<Kooboo.KContent.FolderTypes.Audio,Kooboo.KContent.MutationTypes.Audio> {
  }

  interface PageElement_SubscribePromo extends Kooboo.KContent.folderBase<Kooboo.KContent.FolderTypes.PageElement_SubscribePromo,Kooboo.KContent.MutationTypes.PageElement_SubscribePromo> {
  }

  interface Steps extends Kooboo.KContent.folderBase<Kooboo.KContent.FolderTypes.Steps,Kooboo.KContent.MutationTypes.Steps> {
  }

  interface HomeHero extends Kooboo.KContent.folderBase<Kooboo.KContent.FolderTypes.HomeHero,Kooboo.KContent.MutationTypes.HomeHero> {
  }

  interface Hotels extends Kooboo.KContent.folderBase<Kooboo.KContent.FolderTypes.Hotels,Kooboo.KContent.MutationTypes.Hotels> {
  }

  interface PageElement_SearchBar extends Kooboo.KContent.folderBase<Kooboo.KContent.FolderTypes.PageElement_SearchBar,Kooboo.KContent.MutationTypes.PageElement_SearchBar> {
  }
  ...
  interface CommonButton extends Kooboo.KContent.folderBase<Kooboo.KContent.FolderTypes.CommonButton,Kooboo.KContent.MutationTypes.CommonButton> {
  }

  interface Blog extends Kooboo.KContent.folderBase<Kooboo.KContent.FolderTypes.Blog,Kooboo.KContent.MutationTypes.Blog> {
  }

  interface PageElement_MapCards extends Kooboo.KContent.folderBase<Kooboo.KContent.FolderTypes.PageElement_MapCards,Kooboo.KContent.MutationTypes.PageElement_MapCards> {
  }

  interface SubscriptionPlanPrice extends Kooboo.KContent.folderBase<Kooboo.KContent.FolderTypes.SubscriptionPlanPrice,Kooboo.KContent.MutationTypes.SubscriptionPlanPrice> {
  }

  interface FAQItem extends Kooboo.KContent.folderBase<Kooboo.KContent.FolderTypes.FAQItem,Kooboo.KContent.MutationTypes.FAQItem> {
  }

  interface EmailConfig extends Kooboo.KContent.folderBase<Kooboo.KContent.FolderTypes.EmailConfig,Kooboo.KContent.MutationTypes.EmailConfig> {
  }

  interface PageElement_ContentCard extends Kooboo.KContent.folderBase<Kooboo.KContent.FolderTypes.PageElement_ContentCard,Kooboo.KContent.MutationTypes.PageElement_ContentCard> {
  }

  interface EmbeddedTemplatePages extends Kooboo.KContent.folderBase<Kooboo.KContent.FolderTypes.EmbeddedTemplatePages,Kooboo.KContent.MutationTypes.EmbeddedTemplatePages> {
  }

  interface LableFolder extends Kooboo.KContent.folderBase<Kooboo.KContent.FolderTypes.LableFolder,Kooboo.KContent.MutationTypes.LableFolder> {
  }

  interface PageElement_ImageAndText extends Kooboo.KContent.folderBase<Kooboo.KContent.FolderTypes.PageElement_ImageAndText,Kooboo.KContent.MutationTypes.PageElement_ImageAndText> {
  }

  interface FooterItem extends Kooboo.KContent.folderBase<Kooboo.KContent.FolderTypes.FooterItem,Kooboo.KContent.MutationTypes.FooterItem> {
  }

  interface PageElement_3Cards extends Kooboo.KContent.folderBase<Kooboo.KContent.FolderTypes.PageElement_3Cards,Kooboo.KContent.MutationTypes.PageElement_3Cards> {
  }

  interface LocationHighlights extends Kooboo.KContent.folderBase<Kooboo.KContent.FolderTypes.LocationHighlights,Kooboo.KContent.MutationTypes.LocationHighlights> {
  }

  interface modules_GoogleCode extends Kooboo.KContent.folderBase<Kooboo.KContent.FolderTypes.modules_GoogleCode,Kooboo.KContent.MutationTypes.modules_GoogleCode> {
  }

  interface Clients extends Kooboo.KContent.folderBase<Kooboo.KContent.FolderTypes.Clients,Kooboo.KContent.MutationTypes.Clients> {
  }

  interface EventsTable extends Kooboo.KContent.folderBase<Kooboo.KContent.FolderTypes.EventsTable,Kooboo.KContent.MutationTypes.EventsTable> {
  }

  interface LocationTips extends Kooboo.KContent.folderBase<Kooboo.KContent.FolderTypes.LocationTips,Kooboo.KContent.MutationTypes.LocationTips> {
  }

  interface RegionCard extends Kooboo.KContent.folderBase<Kooboo.KContent.FolderTypes.RegionCard,Kooboo.KContent.MutationTypes.RegionCard> {
  }

  interface PageElement_CategoryMap extends Kooboo.KContent.folderBase<Kooboo.KContent.FolderTypes.PageElement_CategoryMap,Kooboo.KContent.MutationTypes.PageElement_CategoryMap> {
  }

  interface BlogCategory extends Kooboo.KContent.folderBase<Kooboo.KContent.FolderTypes.BlogCategory,Kooboo.KContent.MutationTypes.BlogCategory> {
  }

  interface PageElementBanner extends Kooboo.KContent.folderBase<Kooboo.KContent.FolderTypes.PageElementBanner,Kooboo.KContent.MutationTypes.PageElementBanner> {
  }

  interface PageElement_Testimonials extends Kooboo.KContent.folderBase<Kooboo.KContent.FolderTypes.PageElement_Testimonials,Kooboo.KContent.MutationTypes.PageElement_Testimonials> {
  }

  interface OverGofinestera extends Kooboo.KContent.folderBase<Kooboo.KContent.FolderTypes.OverGofinestera,Kooboo.KContent.MutationTypes.OverGofinestera> {
  }

  interface PageElement_Categories extends Kooboo.KContent.folderBase<Kooboo.KContent.FolderTypes.PageElement_Categories,Kooboo.KContent.MutationTypes.PageElement_Categories> {
  }

  interface EmptyFolder extends Kooboo.KContent.folderBase<Kooboo.KContent.FolderTypes.EmptyFolder,Kooboo.KContent.MutationTypes.EmptyFolder> {
  }

  interface PageElement_TagCard extends Kooboo.KContent.folderBase<Kooboo.KContent.FolderTypes.PageElement_TagCard,Kooboo.KContent.MutationTypes.PageElement_TagCard> {
  }

  interface PlanItem extends Kooboo.KContent.folderBase<Kooboo.KContent.FolderTypes.PlanItem,Kooboo.KContent.MutationTypes.PlanItem> {
  }

  interface Locations extends Kooboo.KContent.folderBase<Kooboo.KContent.FolderTypes.Locations,Kooboo.KContent.MutationTypes.Locations> {
  }

  interface Icons extends Kooboo.KContent.folderBase<Kooboo.KContent.FolderTypes.Icons,Kooboo.KContent.MutationTypes.Icons> {
  }

  interface Map extends Kooboo.KContent.folderBase<Kooboo.KContent.FolderTypes.Map,Kooboo.KContent.MutationTypes.Map> {
  }

  interface Header extends Kooboo.KContent.folderBase<Kooboo.KContent.FolderTypes.Header,Kooboo.KContent.MutationTypes.Header> {
  }

  interface HeaderItem extends Kooboo.KContent.folderBase<Kooboo.KContent.FolderTypes.HeaderItem,Kooboo.KContent.MutationTypes.HeaderItem> {
  }

  interface SubscriptionPlan extends Kooboo.KContent.folderBase<Kooboo.KContent.FolderTypes.SubscriptionPlan,Kooboo.KContent.MutationTypes.SubscriptionPlan> {
  }

  interface StepItemAudios extends Kooboo.KContent.folderBase<Kooboo.KContent.FolderTypes.StepItemAudios,Kooboo.KContent.MutationTypes.StepItemAudios> {
  }

  interface PlaceIcons extends Kooboo.KContent.folderBase<Kooboo.KContent.FolderTypes.PlaceIcons,Kooboo.KContent.MutationTypes.PlaceIcons> {
  }

  interface ProductItem extends Kooboo.KContent.folderBase<Kooboo.KContent.FolderTypes.ProductItem,Kooboo.KContent.MutationTypes.ProductItem> {
  }

  interface VIdeo extends Kooboo.KContent.folderBase<Kooboo.KContent.FolderTypes.VIdeo,Kooboo.KContent.MutationTypes.VIdeo> {
  }

  interface CommonCard extends Kooboo.KContent.folderBase<Kooboo.KContent.FolderTypes.CommonCard,Kooboo.KContent.MutationTypes.CommonCard> {
  }

  interface StapItem extends Kooboo.KContent.folderBase<Kooboo.KContent.FolderTypes.StapItem,Kooboo.KContent.MutationTypes.StapItem> {
  }

  interface Footer extends Kooboo.KContent.folderBase<Kooboo.KContent.FolderTypes.Footer,Kooboo.KContent.MutationTypes.Footer> {
  }

  interface PageElement_Clients extends Kooboo.KContent.folderBase<Kooboo.KContent.FolderTypes.PageElement_Clients,Kooboo.KContent.MutationTypes.PageElement_Clients> {
  }

  interface CommonFolder extends Kooboo.KContent.folderBase<Kooboo.KContent.FolderTypes.CommonFolder,Kooboo.KContent.MutationTypes.CommonFolder> {
  }
...
declare namespace KScript.Commerce.Models {
  interface ProductDetail {
    Latitude: string;
    Longitude: string;
    LocationData_Images: string[];
    LocationData_Name: string;
    LocationData_Label: string;
    LocationData_Subtext: string;
    LocationData_Tags_Legenda: string;
    LocationData_Icon: Kooboo.KContent.FolderTypes.Icons;
    LocationData_Tags_Integrality: string;
    LocationData_Tags_Ambiance: string;
    LocationData_Tags_DestinationWorthy: string;
    LocationData_Tags_Era: string;
    LocationData_Tags_Accessibility: string;
    steps: Kooboo.KContent.FolderTypes.Steps;
    Introtext: string;
    Video: string[];
    Audio: Kooboo.KContent.FolderTypes.Audio[];
    Address: string;
    Category: Kooboo.KContent.FolderTypes.Category[];
    LocationData_Tags_Status: string;
    Hotels: Kooboo.KContent.FolderTypes.Hotels[];
    PDF: string[];
    RelatedLocations: Kooboo.KContent.FolderTypes.Locations[];
    Map: Kooboo.KContent.FolderTypes.Map;
    route: string;
    Highlights: Kooboo.KContent.FolderTypes.LocationHighlights;
    Tips: Kooboo.KContent.FolderTypes.LocationTips;
    LocationData_ExternalURL: string;
    LocationData_Logo: string;
  }
